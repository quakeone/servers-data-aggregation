...
namespace ServerDataAggregation.Persistence.Migrations
{
    ...
    [Migration("20260812162831_index-optimization")]
            ...
            modelBuilder.Entity("ServerDataAggregation.Persistence.Models.PlayerMatch", b =>
                {
                    ...
                    b.HasIndex("PlayerMatchEnd", "PlayerMatchStart");
            ...
            modelBuilder.Entity("ServerDataAggregation.Persistence.Models.ServerMatch", b =>
                {
                    ...
                    b.HasIndex("MatchEnd", "MatchStart");

                    b.HasIndex(new[] { "server_id" }, "IX_server_match_server_id");

                    b.HasIndex(new[] { "server_id" }, "IX_server_match_server_id_open")
                        .HasFilter("match_end IS NULL");

                    b.ToTable("server_match");
                });

            modelBuilder.Entity("ServerDataAggregation.Persistence.Models.ServerMatchActual", b =>
                {
                    b.Property<int>("ServerMatchActualId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("server_match_actual_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ServerMatchActualId"));
                    ...
                    b.HasKey("ServerMatchActualId");

                    b.HasIndex("TimeStamp");

                    b.ToTable("server_match_actual");
                });
